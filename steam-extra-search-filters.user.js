...
// @description  Add extra filters (rating, discount, base price, discounted price) to Steam search.
// @author       Xeloses
// @version      1.0
// @license      MIT
...
/**
 * @todo + "Hide TBA (to be announced) games" option
